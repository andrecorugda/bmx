...
<div class="panel"><div class="cap">rendered</div><div class="render">%s</div></div>
</div></div></body></html>"""
open(name + ".html","w").write(tpl % (name, html.escape(src), body))
