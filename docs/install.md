...
that language's version and no say in its own. BMX is 0.10 and Burxt is 1.3; one number could not
honestly carry both.
...
name        my-app
version     0.1.0
dependency  bmx  https://github.com/andrecorugda/bmx  burxt-0.10.0
```
...
dependency  bmx   https://github.com/andrecorugda/bmx         burxt-0.10.0  # star needs this
```
...
release channel, and BMX is 0.10 with two implementations by one author. Copy the file instead —
...
and target BMX 0.10 quite happily.
